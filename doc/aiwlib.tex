...
%\input{introduction} % разжигая ваш аппетит
...
\input{racs/introduction}
\input{racs/data}
\input{racs/use-in-py}
\input{racs/use-in-cpp}
\input{racs/runcalc}
\input{racs/racsutil}
% пример использования - PhaseOsc
...
% заключение
%   статьи про aiwlib
%   применение (проекты и список литературы) aiwlib
%   проеты в которых испольщовались форматы данных aiwlib (и список литературы)
